...
# Load environment variables with a default voice
env_vars = dotenv_values(".env")
AssitantVoice = env_vars.get(
    "AssitantVoice",
...
async def TextToAudioFile(text) -> None:
    try:
        ...
        # Print for debugging
        print(f"Using voice: {AssitantVoice}")

        communicate = edge_tts.Communicate(
            text, AssitantVoice, pitch="+5Hz", rate="+13%"
        )
...
if __name__ == "__main__":
    ...
    print(f"Current voice setting: {AssitantVoice}")
